...
### 3. Unisciti alla community di Tumble Code

<!-- - **Principale:** Unisciti al nostro [Discord](https://discord.gg/tumblecode) e invia un DM a **Hannes Rudolph (`hrudolph`)**. -->

- **Alternativa:** I contributori esperti possono interagire direttamente tramite i [progetti GitHub](https://github.com/orgs/QUB-IT/projects/1).
...
- Controlla il [progetto GitHub](https://github.com/orgs/QUB-IT/projects/1) per le issue "Issue [Non assegnata]".
- Per la documentazione, visita [Tumble Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
```
git clone https://github.com/TUO_NOME_UTENTE/tumble-code.git
```
...
<!-- - Deve fare riferimento a un'issue di GitHub assegnata. Per essere assegnato: commenta "Rivendico" sull'issue e invia un DM a **Hannes Rudolph (`hrudolph`)** su [Discord](https://discord.gg/tumblecode). L'assegnazione verrà confermata nel thread. -->
...
Contribuendo, accetti che i tuoi contributi siano concessi in licenza con la licenza Apache 2.0, in coerenza con la licenza di Tumble Code.
