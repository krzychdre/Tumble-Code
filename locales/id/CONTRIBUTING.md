...
- Periksa [Proyek GitHub](https://github.com/orgs/QUB-IT/projects/1) untuk masalah "Masalah [Belum Ditugaskan]".
- Untuk dokumentasi, kunjungi [Dokumentasi Tumble Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
```
git clone https://github.com/NAMA_PENGGUNA_ANDA/tumble-code.git
```
...
Dengan berkontribusi, Anda setuju bahwa kontribusi Anda akan dilisensikan di bawah Lisensi Apache 2.0, sesuai dengan lisensi Tumble Code.
