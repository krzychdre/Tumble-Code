...
### 3. Tumble Code समुदाय में शामिल हों

<!-- - **प्राथमिक:** हमारे [डिस्कॉर्ड](https://discord.gg/tumblecode) में शामिल हों और **Hannes Rudolph (`hrudolph`)** को डीएम करें। -->

- **वैकल्पिक:** अनुभवी योगदानकर्ता [गिटहब प्रोजेक्ट्स](https://github.com/orgs/QUB-IT/projects/1) के माध्यम से सीधे जुड़ सकते हैं।
...
<!-- - **मौजूदा समस्याओं की जाँच करें**: [गिटहब समस्याएँ](https://github.com/krzychdre/tumble-code/issues) में खोजें। -->

- **एक समस्या बनाएँ** का उपयोग करके: - **सुधार:** "सुधार अनुरोध" टेम्पलेट (उपयोगकर्ता लाभ पर केंद्रित सरल भाषा)। - **बग:** "बग रिपोर्ट" टेम्पलेट (न्यूनतम प्रतिकृति + अपेक्षित बनाम वास्तविक + संस्करण)।
    <!-- - **इस पर काम करना चाहते हैं?** समस्या पर "दावा करना" टिप्पणी करें और असाइन होने के लिए [डिस्कॉर्ड](https://discord.gg/tumblecode) पर **Hannes Rudolph (`hrudolph`)** को डीएम करें। असाइनमेंट की पुष्टि थ्रेड में की जाएगी। -->
- **पीआर को समस्या से लिंक करना होगा।** अनलिंक किए गए पीआर बंद किए जा सकते हैं।

### क्या काम करना है यह तय करना

- "समस्या [असाइन नहीं की गई]" समस्याओं के लिए [गिटहब प्रोजेक्ट](https://github.com/orgs/QUB-IT/projects/1) की जाँच करें।
- दस्तावेज़ों के लिए, [Tumble Code दस्तावेज़](https://github.com/RooCodeInc/Roo-Code-Docs) पर जाएँ।

### बग की रिपोर्ट करना

- पहले मौजूदा रिपोर्ट की जाँच करें।
      <!-- - ["बग रिपोर्ट" टेम्पलेट](https://github.com/krzychdre/tumble-code/issues/new/choose) का उपयोग करके एक नया बग बनाएँ: -->
          - स्पष्ट, क्रमांकित पुनरुत्पादन चरण
          - अपेक्षित बनाम वास्तविक परिणाम
          - Tumble Code संस्करण (आवश्यक); यदि प्रासंगिक हो तो एपीआई प्रदाता/मॉडल
      <!-- - **सुरक्षा समस्याएँ**: [सुरक्षा सलाहकारों](https://github.com/krzychdre/tumble-code/security/advisories/new) के माध्यम से निजी तौर पर रिपोर्ट करें। -->
...
```
git clone https://github.com/आपका_उपयोगकर्ता_नाम/tumble-code.git
```
...
<!-- - एक असाइन की गई गिटहब समस्या का संदर्भ देना होगा। असाइन होने के लिए: समस्या पर "दावा करना" टिप्पणी करें और [डिस्कॉर्ड](https://discord.gg/tumblecode) पर **Hannes Rudolph (`hrudolph`)** को डीएम करें। असाइनमेंट की पुष्टि थ्रेड में की जाएगी। -->
...
योगदान करके, आप सहमत हैं कि आपके योगदान अपाचे 2.0 लाइसेंस के तहत लाइसेंस प्राप्त होंगे, जो Tumble Code के लाइसेंस के अनुरूप है।
