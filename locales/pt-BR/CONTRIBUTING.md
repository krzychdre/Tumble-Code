...
- Verifique o [Projeto do GitHub](https://github.com/orgs/QUB-IT/projects/1) para issues "Issue [Não atribuída]".
- Para documentação, visite [Documentação do Tumble Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
```
git clone https://github.com/SEU_NOME_DE_USUARIO/tumble-code.git
```
...
Ao contribuir, você concorda que suas contribuições serão licenciadas sob a Licença Apache 2.0, consistente com o licenciamento do Tumble Code.
