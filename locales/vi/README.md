...
> ### Plugin Tumble Code sẽ không biến mất.
>
> Bạn có thể đã thấy [thông báo gần đây](https://x.com/mattrubens/status/2046636598859559114) rằng Tumble Code đã đạt 3 triệu lượt cài đặt và đội ngũ ban đầu đang dồn toàn lực cho Roomote. Chúng tôi biết rằng tin này thật khó khăn với nhiều bạn. Plugin này có ý nghĩa rất lớn với chúng tôi và với bạn, và chúng tôi lắng nghe bạn.
>
> Tin tốt: **một đội ngũ từ cộng đồng đã đứng ra tiếp tục đưa Tumble Code đi tiếp**, và chúng tôi đang làm việc với họ về việc bàn giao chính thức để plugin mà bạn đang tin cậy tiếp tục được bảo trì và cải thiện.
...
## Tumble Code có thể làm gì cho BẠN?
...
Tumble Code thích ứng với cách bạn làm việc, chứ không phải ngược lại:
...
Xem thêm: [Sử dụng Chế độ](https://docs.tumblecode.dev/basic-usage/using-modes) • [Chế độ tùy chỉnh](https://docs.tumblecode.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.tumblecode.dev/tutorial-videos">Thêm video hướng dẫn và tính năng nhanh...</a>
</p>
...
Có một số cách để chạy phần mở rộng Tumble Code:

### Chế độ phát triển (F5)

Để phát triển tích cực, hãy sử dụng tính năng gỡ lỗi tích hợp của VSCode:

Nhấn `F5` (hoặc vào **Run** → **Start Debugging**) trong VSCode. Thao tác này sẽ mở một cửa sổ VSCode mới với phần mở rộng Tumble Code đang chạy.
...
1.  Đầu tiên, hãy xây dựng gói VSIX:
    ...
    pnpm vsix
    ```
2.  Một tệp `.vsix` sẽ được tạo trong thư mục `bin/` (ví dụ: `bin/tumble-code-<version>.vsix`).
