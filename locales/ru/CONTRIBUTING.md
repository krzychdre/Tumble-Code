...
### 3. Присоединяйтесь к сообществу Tumble Code

<!-- - **Основной:** Присоединяйтесь к нашему [Discord](https://discord.gg/tumblecode) и напишите личное сообщение **Hannes Rudolph (`hrudolph`)**. -->

- **Альтернатива:** Опытные участники mogą напрямую взаимодействовать через [Проекты GitHub](https://github.com/orgs/QUB-IT/projects/1).
...
<!-- - **Проверьте существующие задачи**: выполните поиск в [задачах GitHub](https://github.com/krzychdre/tumble-code/issues). -->

- **Создайте задачу**, используя: - **Улучшения:** шаблон «Запрос на улучшение» (простой язык, ориентированный на пользу для пользователя). - **Ошибки:** шаблон «Отчет об ошибке» (минимальное воспроизведение + ожидаемый и фактический результат + версия).
  <!-- - **Хотите над этим поработать?** Напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/tumblecode), чтобы вас назначили. Назначение будет подтверждено в ветке. -->
- **PR должны ссылаться на задачу.** Несвязанные PR могут быть закрыты.

### Решение, над чем работать

- Проверьте [Проект GitHub](https://github.com/orgs/QUB-IT/projects/1) на наличие задач «Задача [не назначена]».
- Для документации посетите [Документацию Tumble Code](https://github.com/RooCodeInc/Roo-Code-Docs).

### Сообщение об ошибках

- Сначала проверьте существующие отчеты.
    <!-- - Создайте новую ошибку, используя [шаблон «Отчет об ошибке»](https://github.com/krzychdre/tumble-code/issues/new/choose) с: -->
        - Четкими, пронумерованными шагами воспроизведения
        - Ожидаемым и фактическим результатом
        - Версией Tumble Code (обязательно); поставщиком/моделью ИИ, если применимо
    <!-- - **Проблемы с безопасностью**: сообщайте в частном порядке через [рекомендации по безопасности](https://github.com/krzychdre/tumble-code/security/advisories/new). -->
...
```
git clone https://github.com/ВАШЕ_ИМЯ_ПОЛЬЗОВАТЕЛЯ/tumble-code.git
```
...
<!-- - Должен ссылаться на назначенную задачу GitHub. Чтобы вас назначили: напишите комментарий «Забираю» к задаче и напишите личное сообщение **Hannes Rudolph (`hrudolph`)** в [Discord](https://discord.gg/tumblecode). Назначение будет подтверждено в ветке. -->
...
Внося свой вклад, вы соглашаетесь с тем, что ваши вклады будут лицензироваться по лицензии Apache 2.0, в соответствии с лицензированием Tumble Code.
