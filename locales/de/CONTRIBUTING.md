...
- Überprüfe das [GitHub-Projekt](https://github.com/orgs/QUB-IT/projects/1) auf „Issue [Unassigned]“-Issues.
- Für Dokumentation besuche [Tumble Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
```
git clone https://github.com/DEIN_BENUTZERNAME/tumble-code.git
```
...
Indem du einen Beitrag leistest, stimmst du zu, dass deine Beiträge unter der Apache-2.0-Lizenz lizenziert werden, die mit der Lizenzierung von Tumble Code übereinstimmt.
