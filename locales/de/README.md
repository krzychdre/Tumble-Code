...
<p align="center">
  <em>Schnelle Hilfe → <a href="https://discord.gg/tumblecode">Discord beitreten</a> • Lieber asynchron? → <a href="https://www.reddit.com/r/TumbleCode/">r/Tumble Code beitreten</a></em>
</p>
...
> ### Das Tumble Code-Plugin verschwindet nicht.
>
> Du hast vielleicht die [neuliche Ankündigung](https://x.com/mattrubens/status/2046636598859559114) gesehen, dass Tumble Code 3 Millionen Installationen erreicht hat und das ursprüngliche Team sich voll auf Roomote konzentriert. Wir wissen, dass diese Nachricht für viele von euch schwer war. Dieses Plugin bedeutet uns und dir sehr viel, und wir hören dich.
>
> Die gute Nachricht: **ein Community-Team hat sich bereit erklärt, Tumble Code weiterzuführen**, und wir arbeiten mit ihnen an einer offiziellen Übergabe, damit das Plugin, auf das du dich verlässt, weiterhin gepflegt und verbessert wird.
...
## Was kann Tumble Code für DICH tun?
...
Tumble Code passt sich an deine Arbeitsweise an, nicht umgekehrt:
...
Mehr erfahren: [Modi verwenden](https://docs.tumblecode.dev/basic-usage/using-modes) • [Benutzerdefinierte Modi](https://docs.tumblecode.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.tumblecode.dev/tutorial-videos">Weitere schnelle Tutorial- und Feature-Videos...</a>
</p>
...
Es gibt mehrere Möglichkeiten, die Tumble Code-Erweiterung auszuführen:

### Entwicklungsmodus (F5)

Für die aktive Entwicklung verwende das integrierte Debugging von VSCode:

Drücke `F5` (oder gehe zu **Ausführen** → **Debuggen starten**) in VSCode. Dies öffnet ein neues VSCode-Fenster mit der laufenden Tumble Code-Erweiterung.
...
1.  Erstelle zuerst das VSIX-Paket:
    ...
    pnpm vsix
    ```
2.  Eine `.vsix`-Datei wird im `bin/`-Verzeichnis generiert (z. B. `bin/tumble-code-<version>.vsix`).
