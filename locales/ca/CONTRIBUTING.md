...
# Contribuir a Tumble Code

Tumble Code és un projecte impulsat per la comunitat i valorem profundament cada contribució. Per agilitzar la col·laboració, operem sobre una base de [primer la incidència](#enfocament-de-primera-incidència), la qual cosa significa que totes les [sol·licituds d'extracció (PR)](#enviament-duna-sollicitud-dextracció) primer han d'estar enllaçades a una incidència de GitHub. Si us plau, reviseu aquesta guia amb atenció.
...
### 3. Uniu-vos a la comunitat de Tumble Code

<!-- - **Principal:** Uniu-vos al nostre [Discord](https://discord.gg/tumblecode) i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)**. -->

- **Alternativa:** Els col·laboradors experimentats poden participar directament a través de [Projectes de GitHub](https://github.com/orgs/QUB-IT/projects/1).
...
- Consulteu el [Projecte de GitHub](https://github.com/orgs/QUB-IT/projects/1) per a incidències "Incidència [No assignada]".
- Per a documents, visiteu [Documents de Tumble Code](https://github.com/RooCodeInc/Roo-Code-Docs).
...
```
git clone https://github.com/EL_TEU_NOM_USUARI/tumble-code.git
```
...
<!-- - Ha de fer referència a una incidència de GitHub assignada. Per ser assignat: comenteu "Reclamant" a la incidència i envieu un missatge directe a **Hannes Rudolph (`hrudolph`)** a [Discord](https://discord.gg/tumblecode). L'assignació es confirmarà al fil. -->
...
En contribuir, accepteu que les vostres contribucions es llicenciaran sota la llicència Apache 2.0, d'acord amb la llicència de Tumble Code.
