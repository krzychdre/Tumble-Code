...
# Contribuer à Tumble Code

Tumble Code est un projet communautaire, et nous apprécions profondément chaque contribution. Pour simplifier la collaboration, nous fonctionnons sur une base [d'abord l'issue](#approche-issue-first), ce qui signifie que toutes les [Pull Requests (PRs)](#soumettre-une-pull-request) doivent d'abord être liées à une Issue GitHub. Veuillez lire attentivement ce guide.
...
- Consultez le [Projet GitHub](https://github.com/orgs/QUB-IT/projects/1) pour les issues "Issue [Non assignée]".
- Pour la documentation, visitez [Tumble Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
```
git clone https://github.com/VOTRE_NOM_UTILISATEUR/tumble-code.git
```
...
En contribuant, vous acceptez que vos contributions soient sous licence Apache 2.0, conformément à la licence de Tumble Code.
