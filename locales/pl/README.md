...
> ### Wtyczka Tumble Code nie znika.
>
> Być może widziałeś [niedawne ogłoszenie](https://x.com/mattrubens/status/2046636598859559114), że Tumble Code osiągnął 3 miliony instalacji, a oryginalny zespół całkowicie skupia się na Roomote. Wiemy, że ta wiadomość była trudna dla wielu z was. Ta wtyczka wiele dla nas i dla ciebie znaczy, i słyszymy was.
>
> Dobra wiadomość: **zespół społeczności zgłosił się, żeby poprowadzić Tumble Code dalej**, i pracujemy z nimi nad oficjalnym przekazaniem, żeby wtyczka, na której polegasz, była nadal utrzymywana i ulepszana.
...
## Co Tumble Code może zrobić dla CIEBIE?
...
Tumble Code dostosowuje się do Twojego sposobu pracy, a nie odwrotnie:
...
Więcej: [Korzystanie z trybów](https://docs.tumblecode.dev/basic-usage/using-modes) • [Tryby niestandardowe](https://docs.tumblecode.dev/advanced-usage/custom-modes)
...
<p align="center">
<a href="https://docs.tumblecode.dev/tutorial-videos">Więcej szybkich filmów instruktażowych i prezentujących funkcje...</a>
</p>
...
Istnieje kilka sposobów na uruchomienie rozszerzenia Tumble Code:

### Tryb deweloperski (F5)

Do aktywnego programowania użyj wbudowanego debugowania VSCode:

Naciśnij `F5` (lub przejdź do **Uruchom** → **Rozpocznij debugowanie**) w VSCode. Otworzy to nowe okno VSCode z uruchomionym rozszerzeniem Tumble Code.
...
1.  Najpierw zbuduj pakiet VSIX:
    ...
    pnpm vsix
    ```
2.  Plik `.vsix` zostanie wygenerowany w katalogu `bin/` (np. `bin/tumble-code-<version>.vsix`).
