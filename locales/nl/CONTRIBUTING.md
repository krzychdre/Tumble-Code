...
# Bijdragen aan Tumble Code

Tumble Code is een door de gemeenschap gedreven project en we waarderen elke bijdrage ten zeerste. Om de samenwerking te stroomlijnen, werken we op basis van een [Issue-First-aanpak](#issue-first-aanpak), wat betekent dat alle [Pull Requests (PR's)](#een-pull-request-indienen) eerst gekoppeld moeten zijn aan een GitHub Issue. Lees deze handleiding zorgvuldig door.
...
- Controleer het [GitHub Project](https://github.com/orgs/QUB-IT/projects/1) voor "Issue [Niet-toegewezen]" issues.
- Ga voor documentatie naar [Tumble Code Docs](https://github.com/RooCodeInc/Roo-Code-Docs).
...
```
git clone https://github.com/JOUW_GEBRUIKERSNAAM/tumble-code.git
```
...
Door bij te dragen, ga je ermee akkoord dat je bijdragen onder de Apache 2.0-licentie worden gelicentieerd, in overeenstemming met de licentieverlening van Tumble Code.
