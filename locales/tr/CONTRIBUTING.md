...
- "Sorun [Atanmamış]" sorunları için [GitHub Projesi](https://github.com/orgs/QUB-IT/projects/1)'ni kontrol edin.
- Belgeler için [Tumble Code Belgeleri](https://github.com/RooCodeInc/Roo-Code-Docs)ni ziyaret edin.
...
```
git clone https://github.com/KULLANICI_ADINIZ/tumble-code.git
```
...
Katkıda bulunarak, katkılarınızın Tumble Code'un lisanslamasıyla tutarlı olan Apache 2.0 Lisansı altında lisanslanacağını kabul etmiş olursunuz.
