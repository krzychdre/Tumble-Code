...
// Decoration types are created lazily on first use, NOT at module scope:
// a module-scope createTextEditorDecorationType call forces every transitive
// importer of this file to fully mock `vscode.window` before importing.
