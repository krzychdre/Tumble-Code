...
export const openAiNativeModels = {
	// GPT-6 prices: https://developers.openai.com/api/docs/pricing (checked 2026-09-24).
	// Above 272K input tokens the whole request bills at 2x input/cache and 1.5x output.
	"gpt-6-astra": {
		maxTokens: 128_000,
		...
		// Astra rejects `none` with HTTP 400, so reasoning cannot be switched off.
		...
		description: "GPT-6 Astra: OpenAI's flagship model for demanding end-to-end work",
	},
	"gpt-6-sol": {
		maxTokens: 128_000,
		contextWindow: 1_050_000,
		...
		supportsTemperature: false,
		description: "GPT-6 Sol: Cost-efficient high-end model for demanding professional work",
	},
	"gpt-6-luna": {
		maxTokens: 128_000,
		contextWindow: 1_050_000,
		...
		supportsTemperature: false,
		description: "GPT-6 Luna: Fast, low-cost model for high-volume and latency-sensitive work",
	},
	"gpt-5.6-sol": {
		maxTokens: 128_000,
		contextWindow: 1_050_000,
