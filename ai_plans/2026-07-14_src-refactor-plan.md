...
> - [`COGNITIVE_COMPLEXITY_ANALYSIS.md`](ai_plans/archive/COGNITIVE_COMPLEXITY_ANALYSIS.md:1) reconfirmed **stale** (2026-05-03); its #1 finding (`Task.ts` 4,738 lines) is obsolete. Do not re-derive from it.
